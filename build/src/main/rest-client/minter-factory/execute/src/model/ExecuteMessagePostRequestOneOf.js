...
class ExecuteMessagePostRequestOneOf {
     ...
     * CreateMinter will instantiate a new minter contract
     * @alias module:model/ExecuteMessagePostRequestOneOf
     * @param createMinter {module:model/ExecuteMessagePostRequestOneOfCreateMinter} 
     */
    constructor(createMinter) { 
        
        ExecuteMessagePostRequestOneOf.initialize(this, createMinter);
    }
     ...
     */
    static initialize(obj, createMinter) { 
        obj['create_minter'] = createMinter;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('create_minter')) {
                obj['create_minter'] = ExecuteMessagePostRequestOneOfCreateMinter.constructFromObject(data['create_minter']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `create_minter`
        if (data['create_minter']) { // data not null
          ExecuteMessagePostRequestOneOfCreateMinter.validateJSON(data['create_minter']);
        }
...
ExecuteMessagePostRequestOneOf.RequiredProperties = ["create_minter"];

/**
 * @member {module:model/ExecuteMessagePostRequestOneOfCreateMinter} create_minter
 */
ExecuteMessagePostRequestOneOf.prototype['create_minter'] = undefined;
