...
class ExecuteMessagePostRequestOneOf1 {
     ...
     * lists all active minter in reverse chronological order
     * @alias module:model/ExecuteMessagePostRequestOneOf1
     * @param listActiveMinter {module:model/ExecuteMessagePostRequestOneOf1ListActiveMinter} 
     */
    constructor(listActiveMinter) { 
        
        ExecuteMessagePostRequestOneOf1.initialize(this, listActiveMinter);
    }
     ...
     */
    static initialize(obj, listActiveMinter) { 
        obj['list_active_minter'] = listActiveMinter;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('list_active_minter')) {
                obj['list_active_minter'] = ExecuteMessagePostRequestOneOf1ListActiveMinter.constructFromObject(data['list_active_minter']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `list_active_minter`
        if (data['list_active_minter']) { // data not null
          ExecuteMessagePostRequestOneOf1ListActiveMinter.validateJSON(data['list_active_minter']);
        }
...
ExecuteMessagePostRequestOneOf1.RequiredProperties = ["list_active_minter"];

/**
 * @member {module:model/ExecuteMessagePostRequestOneOf1ListActiveMinter} list_active_minter
 */
ExecuteMessagePostRequestOneOf1.prototype['list_active_minter'] = undefined;
