...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.PermitSignature();
  });
  ...
  describe('PermitSignature', function() {
    it('should create an instance of PermitSignature', function() {
      // uncomment below and update the code to test PermitSignature
      //var instance = new KeychApi.PermitSignature();
      //expect(instance).to.be.a(KeychApi.PermitSignature);
    });
