...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf11TokenApprovals();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf11TokenApprovals', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf11TokenApprovals', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf11TokenApprovals
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf11TokenApprovals();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf11TokenApprovals);
    });
