...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ViewerInfo();
  });
  ...
  describe('ViewerInfo', function() {
    it('should create an instance of ViewerInfo', function() {
      // uncomment below and update the code to test ViewerInfo
      //var instance = new KeychApi.ViewerInfo();
      //expect(instance).to.be.a(KeychApi.ViewerInfo);
    });
