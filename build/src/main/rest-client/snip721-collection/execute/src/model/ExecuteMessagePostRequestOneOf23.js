...
class ExecuteMessagePostRequestOneOf23 {
     ...
     * @param removeMinters {module:model/ExecuteMessagePostRequestOneOf23RemoveMinters} 
     */
    constructor(removeMinters) { 
        
        ExecuteMessagePostRequestOneOf23.initialize(this, removeMinters);
    }
     ...
     */
    static initialize(obj, removeMinters) { 
        obj['remove_minters'] = removeMinters;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('remove_minters')) {
                obj['remove_minters'] = ExecuteMessagePostRequestOneOf23RemoveMinters.constructFromObject(data['remove_minters']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `remove_minters`
        if (data['remove_minters']) { // data not null
          ExecuteMessagePostRequestOneOf23RemoveMinters.validateJSON(data['remove_minters']);
        }
...
ExecuteMessagePostRequestOneOf23.RequiredProperties = ["remove_minters"];

/**
 * @member {module:model/ExecuteMessagePostRequestOneOf23RemoveMinters} remove_minters
 */
ExecuteMessagePostRequestOneOf23.prototype['remove_minters'] = undefined;
