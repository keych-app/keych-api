...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf13TransferNft();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf13TransferNft', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf13TransferNft', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf13TransferNft
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf13TransferNft();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf13TransferNft);
    });
