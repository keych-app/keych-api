...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf11ApproveAll();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf11ApproveAll', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf11ApproveAll', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf11ApproveAll
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf11ApproveAll();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf11ApproveAll);
    });
