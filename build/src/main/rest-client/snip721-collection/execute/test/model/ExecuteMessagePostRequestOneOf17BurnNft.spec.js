...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf17BurnNft();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf17BurnNft', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf17BurnNft', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf17BurnNft
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf17BurnNft();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf17BurnNft);
    });
