...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf15SendNft();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf15SendNft', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf15SendNft', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf15SendNft
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf15SendNft();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf15SendNft);
    });
    ...
    it('should have the property receiverInfo (base name: "receiver_info")', function() {
      // uncomment below and update the code to test the property receiverInfo
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf15SendNft();
      //expect(instance).to.be();
    });
