...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf2MintNftClones();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf2MintNftClones', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf2MintNftClones', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf2MintNftClones
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf2MintNftClones();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf2MintNftClones);
    });
    ...
    it('should have the property mintRunId (base name: "mint_run_id")', function() {
      // uncomment below and update the code to test the property mintRunId
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf2MintNftClones();
      //expect(instance).to.be();
    });
