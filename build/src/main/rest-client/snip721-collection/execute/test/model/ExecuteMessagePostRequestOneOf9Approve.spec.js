...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf9Approve();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf9Approve', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf9Approve', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf9Approve
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf9Approve();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf9Approve);
    });
