...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeychApi.ExecuteMessagePostRequestOneOf4SetRoyaltyInfo();
  });
  ...
  describe('ExecuteMessagePostRequestOneOf4SetRoyaltyInfo', function() {
    it('should create an instance of ExecuteMessagePostRequestOneOf4SetRoyaltyInfo', function() {
      // uncomment below and update the code to test ExecuteMessagePostRequestOneOf4SetRoyaltyInfo
      //var instance = new KeychApi.ExecuteMessagePostRequestOneOf4SetRoyaltyInfo();
      //expect(instance).to.be.a(KeychApi.ExecuteMessagePostRequestOneOf4SetRoyaltyInfo);
    });
